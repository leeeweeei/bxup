...
/*		List<String> gymnamelist = new ArrayList<String>();
	...
	public String feedback(Map<String, Object> mode) throws SQLException {
		...
		for(int i=0;i<feedback.size();i++){
			...
			if(userid != 0){
				User userForm = (User) feedBackService.findnikenameById(userid);
	...
	public String eventAdd(Model model,HttpServletRequest request,
			HttpServletResponse response, Event eventInsertForm) {
	...
	public String comfirmeventAdd(Model model,HttpServletRequest request,
		...
		if(CommonConstant.ONE.equals(eventInsertForm.getImg_Type()) || CommonConstant.TWO.equals(eventInsertForm.getImg_Type())){
			return "comfirmevent";
			}
	...
	public String maineventAdd(HttpServletRequest request,
			HttpServletResponse response, Event eventInsertForm
			) throws Exception {
	...
	public String maincoachInfoAdd(Model model,HttpServletRequest request,
			HttpServletResponse response, Coach coachInfoForm
			) throws IllegalStateException, IOException {
	...
	public String maincoachInfoAdd(Model model,HttpServletRequest request,
			HttpServletResponse response, Gym gymInfoForm
			) throws IllegalStateException, IOException {
	...
	//20170314 Baojun Add
		...
		public String userAdd(Model model,HttpServletRequest request,
				HttpServletResponse response, User userForm
				) throws IllegalStateException, IOException {
		...
		public String showAdd(Model model,HttpServletRequest request,
				HttpServletResponse response, Show showForm
...
/*			for(int i=0;i<photo.size();i++){
		...
		public String subscribeInfoAdd(Model model,HttpServletRequest request,
				HttpServletResponse response, Subscribe subscribeForm
				) throws IllegalStateException, IOException {
